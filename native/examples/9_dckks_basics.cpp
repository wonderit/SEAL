...
void example_dckks_basics()
{
    ...
    */
    ...
    keygen.create_public_key(prng_seed_type{ 123 }, public_key);
    PublicKey public_key2;
    keygen.create_public_key(prng_seed_type{ 123 }, public_key2);
    cout << "pub key: " << public_key.data()[0] << "," << public_key.data()[1] << endl;
    cout << "public_key2: " << public_key2.data()[0] << "," << public_key2.data()[1] << endl;
